...
public class LoginRepository {
    ...
    private com.example.cookmaster.ui.Login.LoginDataSource dataSource;
    ...
    private LoginRepository(com.example.cookmaster.ui.Login.LoginDataSource dataSource) {
        this.dataSource = dataSource;
    }

    public static LoginRepository getInstance(com.example.cookmaster.ui.Login.LoginDataSource dataSource) {
        if (instance == null) {
